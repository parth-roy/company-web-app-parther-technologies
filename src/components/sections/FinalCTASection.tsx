    ...
    <section id="cta" className="relative z-10 bg-cf-text text-white py-32 overflow-hidden">
      ...
      <div className="container-main relative z-10 text-center">
        ...
        <h2 className="font-syncopate font-bold text-4xl md:text-6xl tracking-tight mb-8 leading-tight max-w-4xl mx-auto">
          Let's Architect Your Next Competitive Advantage.
        </h2>

        <p className="text-white/60 text-xl max-w-2xl mx-auto mb-6 leading-relaxed">
          One technical conversation can change the trajectory of your business.
          Book a free 30-minute Architecture Review — we'll map your current
          stack, identify bottlenecks, and deliver a written scope with ROI
          projections before you commit anything.
        </p>

        {/* GoMyTruck credibility line */}
        <p className="text-white/35 text-sm font-mono-caps tracking-widest mb-12">
          The same team that shipped GoMyTruck — 500+ drivers, 2-min booking, multi-tenant SaaS.
        </p>
